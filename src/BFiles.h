 ...
 *
 * Created:       06-??-1996  BMB (Created from other files)
 * Last Modified: 01-23-2006  Steven Schulteis
 ***************************************/

/*  This file was created from a copy of BFiles.h from the old MacMolPlt
 *  source.
 *
...
long FindKeyWord(char *buffer, char keyword[], long numbyte);
long ReadStringKeyword(char * Line, char * Keyword, char * Value);
long ReadLongKeyword(char * Line, char * Keyword, long * Value);
long ReadFloatKeyword(char * Line, char * Keyword, float * Value);
long ReadBooleanKeyword(char * Line, char * Keyword, Boolean * Value);
long LocateForValue(char * Line, char * KeyWord);
