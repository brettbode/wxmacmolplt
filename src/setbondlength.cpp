...
////@begin SetBondLength content construction
    // Generated by DialogBlocks, Wed 3 May 15:01:59 2006 (unregistered)
    ...
    maxValueEdit = new wxTextCtrl( itemDialog1, ID_MAXLENGTHEDIT, _("0.00"), wxDefaultPosition, wxDefaultSize, 0 );
    if (ShowToolTips())
    ...
    normalTolSlider = new wxSlider( itemDialog1, ID_NORMALSLIDER, 100, 50, 150, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL );
    if (ShowToolTips())
